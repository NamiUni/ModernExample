...
public final class ModernMessageSource implements IMessageSource<Audience, String> {

    private final Locale defaultLocale;
    private Map<Locale, Properties> locales = Map.of();
    private final Path pluginJar;
    private final ComponentLogger logger;
    private final Path dataDirectory;

    @Inject
    private ModernMessageSource(
            final PluginProviderContext context,
            final ConfigManager configManager
    ) throws IOException {
        this.dataDirectory = context.getDataDirectory();
        this.pluginJar = context.getPluginSource();
    ...
    private String forPlayer(final String key, final Player player) {
